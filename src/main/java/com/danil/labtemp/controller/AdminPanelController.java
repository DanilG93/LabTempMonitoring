...
public class AdminPanelController {
    ...
    @FXML private TableColumn<Device, Number> minCol;
    @FXML private TableColumn<Device, Number> maxCol;
    @FXML private TableColumn<Device, String> regexCol;
    ...
    @FXML private TextField dataRegexField;
    @FXML private TextField alarmRegexField;
    ...
    private void handleSaveCompany() {
        ...
        System.out.println("Podaci o firmi sačuvani: " + name);
        showAlert("Uspešno", "Podaci o firmi su uspešno sačuvani!");
    }
    ...
    private void handleAddDevice() {
        try {
            ...
            deviceList.add(newDevice); // Tabela se automatski osvežava!

            // Čišćenje forme nakon unosa
            deviceNameField.clear(); minTempField.clear(); maxTempField.clear();
            dataRegexField.clear(); alarmRegexField.clear();
